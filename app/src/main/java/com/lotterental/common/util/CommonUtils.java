...
public class CommonUtils {
     ...
     * @param uri     image uri
     * @param resize  리사이즈 할 배수 2배수
     * @return
     */
    public static byte[] uriImageResize(Context context, Uri uri, int resize) {
        ...
        try {
            ...
            resizeBitmap = bitmap;
            return CommonUtils.convertBitmapToByteArray(resizeBitmap);
