...
import com.lotterental.generalrental.activity.BaseActivity;
...
public class LWebView extends WebView {
    ...
    private void init() {
        ...
        setWebViewClient(new GeneralRentalWebClient((BaseActivity) mContext));
        setWebChromeClient(new GeneralRentalWebChromeClient());
